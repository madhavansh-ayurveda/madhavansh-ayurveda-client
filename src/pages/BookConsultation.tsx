...
import { FadeIn, StaggerContainer, StaggerItem, ScaleOnHover, SlideIn } from "@/components/framer-animations"
import { Calendar, Clock, Leaf, Heart } from "lucide-react"
...
export default function BookConsultation() {
  return (
    <div
      ...
      style={{ backgroundImage: "url('/home-background.jpg')", backgroundRepeat: "repeat" }}
    >
        ...
        <div className="max-w-4xl mx-auto">
          <FadeIn>
            <div className="text-center mb-12">
              ...
              <h1 className="text-3xl lg:text-4xl font-bold mb-4 text-balance">Start Your Healing Journey Today</h1>
